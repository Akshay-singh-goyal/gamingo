...
.jodit-popup {
  ...
  z-index: 10000001;
  display: inline-block;
  -webkit-box-shadow: 0 4px 1px -2px rgba(76, 76, 76, 0.2), 0 3px 3px 0 rgba(76, 76, 76, 0.15), 0 1px 4px 0 rgba(76, 76, 76, 0.13);
...
.jodit-tabs .jodit-tabs__buttons .jodit-ui-button:active:not([disabled]) {
  -webkit-box-shadow: 0 0 #0000, 0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.1);
          box-shadow: 0 0 #0000, 0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.1);
  color: rgba(0, 0, 0, 0.75);
}
